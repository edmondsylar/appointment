              ...
              ?>
                <li>
                  ...
                  <ul class="booking_details">
                    <form action="main/back/dates.php" method="POST" class="float-right">
                      <input type="hidden" value="<?php echo $value['id']; ?>" name="id">
                      <input require type="text" class="form-control" name="time" placeholder="Ex: 12:00pm - 3:00pm">
                      <input type="submit" value="add" class="btn_1 float-right" style="border-radius: 0px;">
                    </form>
                    ...
                    <li>
                      <?php if (!empty($times)) : ?>
                        <?php foreach ($times as $key => $value) : ?>
                          <code style="color: blue;"><?php echo $value['time'];?></code> &nbsp;
                        <?php endforeach; ?>
                      <?php endif; ?>
                    </li>
                  </ul>
